...
function ArticlePreviewEdit({ cover, title, description, slug }: articlePreviewType) {
  return (
    <div className="p-6 flex items-center justify-between gap-y-2 w-full rounded-xl box-shadow flex-wrap">
      <Link
        href={`/articles/${slug}`}
      ...
      <div className="flex items-center gap-x-5">
        <div className="flex items-center gap-x-3">
          <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_789_603)">
              <rect width="31" height="31" rx="5" fill="#FF0000" fillOpacity="0.1" />
              <path
        ...
        <div className="flex items-center gap-x-3">
          <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="31" height="30" rx="5" fill="#F920C3" fillOpacity="0.1" />
            <path
          ...
          <h3 className="text-secondary flex-1 w-fit text-xs md:text-sm">{4.5}</h3>
        </div>
      ...
      <div className="flex items-center gap-x-5">
        <Link href={`/panel/articles/${slug}`} className="flex justify-center text-brand">
...
export default ArticlePreviewEdit;

export function ArticlePreviewEditLoading() {
  return (
    <div className="p-6 flex items-center justify-between gap-y-2 w-full rounded-xl box-shadow flex-wrap">
      ...
      <div className="flex items-center gap-x-5">
        <div className="flex items-center gap-x-3">
          ...
          <div className="w-[3rem] lg:w-[2rem] h-[.8rem] loading" />
        </div>
        ...
        <div className="w-[2.5rem] lg:w-[5rem] h-[1rem] loading" />
      </div>
