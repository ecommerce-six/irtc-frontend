...
function Prompt({ message, showHandler, submitHandler }: props) {
  return (
    <>
      <button className="fixed top-0 left-0 bg-gray-400 w-full h-screen opacity-50 z-20" onClick={showHandler} />
      <div className="p-5 fixed top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] flex flex-col items-center w-[20rem] rounded-xl bg-background box-shadow z-30">
