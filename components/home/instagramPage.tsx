...
import { InstagramPhone } from "../../public";

function InstagramPage() {
  return (
    <section className="relative lg:pt-8 py-6 px-12 mt-14 lg:h-48 flex flex-col lg:flex-row items-center justify-end gap-10 bg-gradient-to-br from-[#F920C3] to-brand rounded-3xl">
      <Image
        src={InstagramPhone}
        alt="instagram phone"
        className="absolute -top-20 sm:-top-28 lg:-top-10 lg:right-5 w-52 sm:w-60 lg:w-72 طم:w-80"
      />
